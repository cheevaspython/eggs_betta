<template>
  <div class="card box" v-if="traderData" style="width: 40vw">
    ...
    <div class="card__button-wrapper">
      <b-button type="is-success" @click="makeSellerOrder" style="margin-right: 5px">Создать Заявку</b-button>
...
<script>
import ModalSellerForm from "@/components/forms/ModalSellerForm"
...
export default {
  ...
  methods: {
    filterData() {
      ...
      this.prodAddresses = [].concat(production_address1, production_address2, 
      production_address3, production_address4, production_address5)
    },
    makeSellerOrder(){
      this.$buefy.modal.open({
        parent: this,
        component: ModalSellerForm,
        hasModalCard: true,
        trapFocus: true,
        props:{
