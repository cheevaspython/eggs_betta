...
urlpatterns = [
    ...
    path('contact_person/', include(contact_person_router.urls)),
    path('user_clients_list/', include(guest_card_eggs_router.urls)),
