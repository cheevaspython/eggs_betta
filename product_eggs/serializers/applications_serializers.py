...
from product_eggs.serializers.base_client_serializers import BuyerCardEggsPlusRequisitesSerializer, \
    SellerCardEggsDetailSerializer, BuyerCardEggsDetailSerializer, SellerCardEggsPlusRequisitesSerializer 
