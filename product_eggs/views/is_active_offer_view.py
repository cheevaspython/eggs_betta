...
from product_eggs.serializers.activefieldoffer_serializers import FieldIsActiveOfferSerializer
...
class FieldIsActiveOffApiview(views.APIView):
    ...
    def post(self, request):
        ...
        field_is_active_offer_for_title_search(
            serializer.data['model_title'], serializer.data['model_id'])
